                    ...
                    <div class="card-body">
                        ...
                        <div class="media">
                            <div class="d-flex flex-column vote-controls">
                                ...
                                <a title="This question is not useful" class="vote-down off"><i class="fa fa-caret-down fa-2x"></i></a>
                        ...
                        @foreach($question->answers as $answer)
                            <div class="media">
                                <div class="d-flex flex-column vote-controls">
                                    ...
                                    <span class="votes-count">1234</span>
                                    <a title="This answer is not useful" class="vote-down off"><i class="fa fa-caret-down fa-2x"></i></a>
